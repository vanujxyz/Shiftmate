...
4. `docs/DECISIONS.md`: decisions D-001…D-084. Entries marked **(user)** are the owner's decisions; never reverse them. Add new entries in the same format, starting at **D-085**.
...
- Milestones 1–13 are done. The last commit is `milestone 13: …`.
