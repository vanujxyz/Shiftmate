...
3. `docs/DECISIONS.md` — D-001…D-084. Log new decisions in the same format (next number: **D-085**).
...
## Status
- Milestones 1–13: **done and committed** (the last is `milestone 13: console app …`). Reports: `docs/reports/milestone-N.md`.
- Next: **milestone 14 (assistant "Ask Cat")**. Decisions continue at **D-085**.
