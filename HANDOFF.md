...
3. `docs/DECISIONS.md` — D-001…D-089. Log new decisions in the same format (next number: **D-090**).
...
## Status
- Milestones 1–14: **done and committed** (the last is `milestone 14: Ask Cat assistant …`). Reports: `docs/reports/milestone-N.md`.
- Next: **milestone 15 (voice and camera)**. Decisions continue at **D-090**.
