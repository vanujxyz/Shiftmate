...
3. `docs/DECISIONS.md` — D-001…D-080. Log new decisions in the same format (next number: **D-081**).
...
## Status
- Milestones 1–12: **done and committed** (the last is `milestone 12: cab app B …`). Reports: `docs/reports/milestone-N.md`.
- Next: **milestone 13 (console app)**. Decisions continue at **D-081**.
